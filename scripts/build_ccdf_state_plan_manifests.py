...
IN_MANUAL_NOTE = (
    ...
    "Not extracted in this run: the plan family is not fully complete (25 jurisdictions blocked, 6 needs_review), "
...
RESOLUTIONS: dict[str, dict] = {
    "al": dict(status="agent_ready", url="https://dhr.alabama.gov/wp-content/uploads/2023/04/2025-2027-CCDF-State-Plan-with-Approval-Letter.pdf",
    ...
    "ak": dict(status="blocked_primary_source", index="https://aws.state.ak.us/OnlinePublicNotices/Notices/View.aspx?id=215530",
               reason="TCP connect to aws.state.ak.us:443 timed out (curl 75 s; curl_cffi chrome impersonation 45 s)"),
    "as": dict(status="blocked_primary_source", index="https://www.dhss.as/index.html",
               reason="TLS: www.dhss.as presents a self-signed, expired certificate (CN=cmaster70); verification impossible, not disabled"),
    "az": dict(status="blocked_primary_source", index="https://des.az.gov/services/child-and-family/child-care/child-care-and-development-fund-state-plan",
               reason="HTTP 403 (cloudflare) for requests with browser UA and curl_cffi chrome120/safari17_0/edge101"),
    "ar": dict(status="agent_ready", url="https://dese.ade.arkansas.gov/Files/ACF-118_CCDF_FFY_2025-2027_For_Arkansas_OEC.pdf",
               ...
               tls=True),
    "ca": dict(status="agent_ready", url="https://www.cdss.ca.gov/Portals/9/CCDD/CCDF_2025-2027_CCDF_Approved.pdf",
    ...
    "co": dict(status="blocked_primary_source", index="https://cdec.colorado.gov/resources/state-plans",
               reason="HTTP 403 (CloudFront) for requests with browser UA and curl_cffi chrome120/safari17_0/edge101"),
    "ct": dict(status="blocked_primary_source", index="https://www.ctoec.org/ccdf/",
               reason="HTTP 403 (cloudflare) for requests with browser UA and curl_cffi chrome120/safari17_0/edge101"),
    "de": dict(status="agent_ready", url="https://mychildde.org/wp-content/uploads/4.15.26-ACF-118-CCDF-FFY-2025-2027-For-Delaware.pdf",
               index="https://www.mychildde.org/", version="Initial Plan", plan_status="Approved as of 2024-11-09"),
    "dc": dict(status="agent_ready", url="https://osse.dc.gov/sites/default/files/dc/sites/osse/publication/attachments/CCDF%20FFY%202025-2027%20For%20District%20of%20Columbia.pdf",
    ...
    "fl": dict(status="agent_ready", url="https://www.fldoe.org/file/20628/2025-2027CCDFStatePlan.pdf",
    ...
    "ga": dict(status="blocked_primary_source", index="http://www.decal.ga.gov/BftS/CCDFPlan.aspx",
               reason="connection reset by peer (curl 56) from www.decal.ga.gov for plain curl and curl_cffi"),
    "gu": dict(status="agent_ready", url="https://guamchildcare.com/sites/default/files/ccdf_state_plan_ffy_2025-2027_for_guam_amendment_01.pdf",
    ...
    "hi": dict(status="agent_ready", url="https://humanservices.hawaii.gov/bessd/files/2024/11/ACF-118-CCDF-FFY-2025-2027-For-Hawaii.pdf",
    ...
    "id": dict(status="blocked_primary_source", index="https://healthandwelfare.idaho.gov/providers/child-care-providers/child-care-resources",
               reason="index page reachable; the plan is served from publicdocuments.dhw.idaho.gov (Laserfiche WebLink DocView id=32013), TCP connect timed out"),
    "il": dict(status="agent_ready", url="https://www.dhs.state.il.us/page.aspx?item=163746",
    ...
    "in": dict(status="needs_review", index="https://www.in.gov/fssa/carefinder/information-and-resources2/",
               reason="publisher posts https://www.in.gov/dA/ce627c931e/ACF-118-CCDF-FY2025-2027-IN.pdf?language_id=1: the certified 2024-06-30 submission (399 pages, 7.7 MB, non-CARS layout with attached state rules); the CARS section pattern finds 5 unique labels, so it was not extracted; approved version not posted"),
    "ia": dict(status="agent_ready", url="https://hhs.iowa.gov/media/13429/download?inline",
    ...
    "ks": dict(status="blocked_primary_source", index="https://www.dcf.ks.gov/services/ees/Pages/Child_Care/Child-care-and-early-education.aspx",
               reason="TCP connect to www.dcf.ks.gov:443 timed out (curl 75 s; curl_cffi 45 s)"),
    "ky": dict(status="blocked_primary_source", index="https://www.chfs.ky.gov/agencies/dcbs/dcc/Pages/default.aspx",
               reason="HTTP 403 for requests with browser UA and curl_cffi chrome120/safari17_0/edge101"),
    "la": dict(status="blocked_primary_source", index="https://www.louisianabelieves.com/resources/library/early-childhood-policy-guidance",
               reason="HTTP 403 (cloudflare) for requests with browser UA and curl_cffi chrome120/safari17_0/edge101"),
    "me": dict(status="needs_review", index="https://www.maine.gov/dhhs/ocfs/support-for-families/child-care/paying-for-child-care",
               reason="index link resolves to the 'paying for child care' page, which links CCAP rules only; no FFY 2025-2027 CCDF plan link found without crawling maine.gov"),
    "md": dict(status="blocked_primary_source", index="https://earlychildhood.marylandpublicschools.org/about/ccdf-state-plan",
               reason="landing page 200; the linked plan page https://earlychildhood.marylandpublicschools.org/2025-2027-ccdf-plan returns HTTP 403 'Access denied'"),
    "ma": dict(status="agent_ready", url="https://www.mass.gov/doc/20241108-approved-2025-2027-ccdf-state-plan/download",
    ...
    "mi": dict(status="agent_ready", url="https://www.michigan.gov/mileap/-/media/Project/Websites/mileap/Documents/Early-Childhood-Education/Child-Development-and-Care/data-and-reporting/CARS-118-FFY2025-2027-CCDF-Plan-Print-Template.pdf?rev=7d0ee04737634947b4883ee964af46a7&hash=C3B5F436B5ECD5F2D57742378BDE464C",
    ...
    "mn": dict(status="blocked_primary_source", index="https://mn.gov/dhs/partners-and-providers/program-overviews/child-care-and-early-education/child-care-development-fund/",
               reason="mn.gov redirects to a validate.perfdrive.com (ShieldSquare) bot challenge instead of the page"),
    "ms": dict(status="needs_review", index="https://www.mdhs.ms.gov/reports/plans/",
               reason="publisher's State Plans page lists only the 2022-2024 CCDF State Plan; no FFY 2025-2027 plan found"),
    "mo": dict(status="blocked_primary_source", index="https://dese.mo.gov/childhood/child-care-subsidy/child-care-dev-fund",
               reason="plan link https://dese.mo.gov/media/pdf/acf-118-ccdf-ffy-2025-2027-missouri returns an HTML Drupal antibot form (HTTP 200) instead of the PDF for requests and curl_cffi chrome120"),
    "mt": dict(status="agent_ready", url="https://dphhs.mt.gov/assets/ecfsd/childcare/documentsandresources/MontanaCCDFStatePlan.pdf",
    ...
    "ne": dict(status="blocked_primary_source", index="https://dhhs.ne.gov/Pages/Child-Care-and-Development-Fund-Plan.aspx",
               reason="TCP connect to dhhs.ne.gov:443 timed out (curl 75 s; curl_cffi 45 s)"),
    "nv": dict(status="agent_ready", url="https://www.dss.nv.gov/uploadedFiles/dwssnvgov/content/Care/ACF-118%20CCDF%20FFY%202025-2027%20For%20Nevada_Final%20Submission.pdf",
    ...
    "nh": dict(status="agent_ready", url="https://www.dhhs.nh.gov/sites/g/files/ehbemt476/files/documents2/ccdf-state-plan-2025-2027.pdf",
    ...
    "nj": dict(status="blocked_primary_source", index=INDEX,
               reason="plan PDF https://www.childcarenj.gov/ChildCareNJ/media/media_library/CCDF_State_Plan_for_New_Jersey_FFY25-27.pdf returns HTTP 403 (cloudflare) for requests and curl_cffi chrome120/safari17_0/edge101"),
    "nm": dict(status="agent_ready", url="https://www.nmececd.org/wp-content/uploads/2025/04/Approved-FFY2025-2027-Child-Care-and-Development-Fund-State-Plan.pdf",
               index="https://www.nmececd.org/ccdfsessions/", version="Initial Plan", plan_status="Approved as of 2024-11-09"),
    "ny": dict(status="blocked_primary_source", index="https://ocfs.ny.gov/main/childcare/stateplan/",
               reason="ocfs.ny.gov returns an F5/Shape JavaScript bot-challenge page (TSPD) instead of the index"),
    "nc": dict(status="agent_ready", url="https://ncchildcare.ncdhhs.gov/Portals/0/documents/pdf/A/ACF-118_CCDF_FFY_2025-2027_For_North_Carolina_November_2024.pdf?ver=5Qk3uXFjaCh3xyBqG3faZg%3d%3d",
    ...
    "nd": dict(status="agent_ready", url="https://www.hhs.nd.gov/sites/default/files/documents/website-archive/human-services/2025-2027-ccdfstateplan-initial-archived.pdf",
    ...
    "mp": dict(status="blocked_primary_source", index="https://www.childcare.gov.mp/",
               reason="HTTP 403 (nginx) for requests with browser UA and curl_cffi chrome120/safari17_0/edge101"),
    "oh": dict(status="agent_ready", url="https://dam.assets.ohio.gov/image/upload/childrenandyouth.ohio.gov/For%20Providers/CCDF/Approved_State_Plan_2025-2027.pdf",
    ...
    "ok": dict(status="agent_ready", url="https://oklahoma.gov/content/dam/ok/en/okdhs/documents/okdhs-pdf-library/child-care-services/ACF-118%20CCDF%20FFY%202025-2027%20For%20Oklahoma.pdf",
               index=INDEX, version="Initial Plan", plan_status="Approved as of 2024-11-09 (linked directly from the ACF index)"),
    "or": dict(status="blocked_primary_source", index="https://www.oregon.gov/delc/about-us/pages/state-plans.aspx",
               reason="DNS resolution of www.oregon.gov failed from this network (curl 6) for plain curl and curl_cffi"),
    "pa": dict(status="needs_review", index="https://www.pa.gov/agencies/dhs",
               reason="ACF index link http://www.dhs.pa.gov/Service/children/pages/child-care-early-learning.aspx redirects to the generic pa.gov DHS agency page; plan not located without crawling pa.gov"),
    "pr": dict(status="needs_review", index="https://www.acuden.pr.gov/documentos",
               reason="publisher's documents page lists only 'Borrador Plan Estatal Child Care 2025-2027' (draft) plus hearing notices and supporting studies; no approved plan"),
    "ri": dict(status="blocked_primary_source", index="https://dhs.ri.gov/regulations/state-plans",
               reason="HTTP 403 (cloudflare) for requests with browser UA and curl_cffi chrome120/safari17_0/edge101"),
    "sc": dict(status="blocked_primary_source", index="https://www.scchildcare.org/resources/",
               reason="TCP connect to www.scchildcare.org:443 timed out (curl 75 s; curl_cffi 45 s)"),
    "sd": dict(status="agent_ready", url="https://dss.sd.gov/docs/childcare/state_plan/2025-2027/2025-2027_State_Plan_original.pdf",
    ...
    "tn": dict(status="blocked_primary_source", index="https://www.tn.gov/humanservices/information-and-resources/tdhs-reports-and-information.html",
               reason="requests read timeout; HTTP 403 for curl_cffi chrome120/safari17_0/edge101"),
    "tx": dict(status="blocked_primary_source", index="https://www.twc.texas.gov/programs/child-care/data-reports-plans",
               reason="HTTP 403 (CloudFront) for requests with browser UA and curl_cffi chrome120/safari17_0/edge101"),
    "ut": dict(status="blocked_primary_source", index="https://jobs.utah.gov/occ/plans.html",
               reason="HTTP 403 (awselb) for requests with browser UA and curl_cffi chrome120/safari17_0/edge101"),
    "vt": dict(status="blocked_primary_source", index="https://dcf.vermont.gov/CDD/CCDF",
               reason="index page 200; plan PDF https://outside.vermont.gov/dept/DCF/Shared%20Documents/CDD/Reports/CCDF-Plans/CCDF-Plan-2025-2027-Approved.pdf returns HTTP 403 'The requested URL was rejected' (F5) for requests and curl_cffi chrome120"),
    "vi": dict(status="needs_review", index="https://dhs.vi.gov/",
               reason="publisher's site lists only a CCDF preprint draft for FFY 2019-2021; no FFY 2025-2027 plan found"),
    "va": dict(status="blocked_primary_source", index="https://www.childcare.virginia.gov/reports-resources/administrative-program-manuals-reports-and-data/virginia-child-care-plan",
               reason="HTTP 403 (AkamaiGHost) for requests with browser UA and curl_cffi chrome120/safari17_0/edge101"),
    "wa": dict(status="agent_ready", url="https://www.dcyf.wa.gov/sites/default/files/pdf/2025-2027-CCDF-Current-Plan.pdf",
    ...
    "wv": dict(status="agent_ready", url="https://bfa.wv.gov/media/39915/download?inline",
               index=INDEX, version="Initial Plan", plan_status="Approved as of 2024-11-09 (linked directly from the ACF index)"),
    "wi": dict(status="agent_ready", url="https://dcf.wisconsin.gov/files/wishares/ccdbg/2025-27-ccdf-plan-draft-10-2024.pdf",
    ...
    "wy": dict(status="agent_ready", url="https://drive.google.com/file/d/10TJ3S8d_nwyNxdkkbyk2gzCfHTk7CTcA/view?usp=sharing",
